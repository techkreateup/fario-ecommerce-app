                                    ...
                                    {currentRecs.map((product) => (
                                        <div key={product.id} className="group cursor-pointer">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <button
                                                    className="mt-2 w-full py-1 text-[10px] font-bold uppercase tracking-widest bg-fario-purple text-white rounded hover:bg-[#684389] transition-colors shadow-sm"
                                ...
                                <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        {PRODUCTS.slice(4, 7).map(item => (
                                            <div key={item.id} className="flex gap-3 group cursor-pointer" onClick={() => navigate(`/products/${item.id}`)}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-xs font-medium text-gray-600 group-hover:text-fario-purple group-hover:underline line-clamp-2 leading-tight mb-1 transition-colors">{item.name}</p>
                                                    <div className="flex text-yellow-500 text-[8px] mb-1">
                                                        <Star fill="currentColor" size={8} /><Star fill="currentColor" size={8} /><Star fill="currentColor" size={8} /><Star fill="currentColor" size={8} /><Star size={8} />
                                                    </div>
                                                    <p className="text-xs font-black text-gray-900 mb-1">{formatPrice(item.price)}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
