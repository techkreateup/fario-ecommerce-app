        ...
        <div className="min-h-screen bg-white font-sans text-gray-800 relative isolate pt-24 pb-32">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in slide-in-from-right-8 duration-500">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                        <div className="text-sm text-gray-900 font-medium">
                                            Order confirmation email will be sent to <span className="font-bold">akash@example.com</span>
                                        </div>
                                        <button
                                ...
                                <div className="p-0">
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="w-full md:w-1/3 bg-gray-50 border-r border-gray-100">
                                            {['UPI', 'Wallets', 'Credit / Debit / ATM Card', 'Net Banking', 'Cash on Delivery'].map((method, idx) => (
                                                <div
                                                    key={method}
                                                    onClick={() => {
                                        ...
                                        <div className="w-full md:w-2/3 p-6 bg-white">
                                            ...
                                            {paymentMethod === 'cod' && (
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="h-24 bg-red-100 flex items-center justify-center border border-red-200 rounded text-red-400 text-xs font-bold uppercase tracking-widest">
                                                        Captcha Placeholder
                                                    </div>
                                                    <button className="text-fario-purple font-bold text-sm uppercase">Confirm Order</button>
                                                </div>
                                            )}
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-[#fb641b] hover:bg-[#f4511e] text-white py-4 rounded-sm text-sm font-bold uppercase tracking-widest shadow-md transition-all mt-6 flex justify-center items-center gap-2"
                                            >
                    ...
                    <div className="lg:col-span-4 pl-0 lg:pl-4 mt-6 lg:mt-0">
                        <div className="sticky top-24 bg-white rounded-sm border border-gray-200 shadow-sm overflow-hidden">
