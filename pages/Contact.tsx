...
const Contact: React.FC = () => {
  ...
  return (
    <div className="pt-24 pb-36 min-h-screen bg-fario-light relative overflow-x-hidden selection:bg-fario-purple selection:text-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <section className="bg-fario-dark rounded-[3rem] p-6 md:p-10 lg:p-20 relative overflow-hidden text-white shadow-2xl mb-12 sm:mb-0">
