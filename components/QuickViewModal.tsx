               ...
               <div className="space-y-8 mb-8">
                  ...
                  <div className="flex items-end gap-3 pt-4 border-t border-gray-50">
                     <div className="flex flex-col">
                        ...
                        <span className="text-3xl font-black text-fario-dark italic tracking-tighter">₹{product.price}</span>
                     </div>
                     {product.originalPrice && (
                       <span className="text-sm font-bold text-gray-300 line-through mb-1.5 ml-2">₹{product.originalPrice}</span>
                     )}
                  </div>
               </div>
