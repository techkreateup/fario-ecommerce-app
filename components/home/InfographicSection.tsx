...
const MotionPath = (motion as any).path;
const MotionLine = (motion as any).line;
const MotionCircle = (motion as any).circle;
const MotionEllipse = (motion as any).ellipse;
const MotionRect = (motion as any).rect;
  ...
  },
  {
    ...
    visual: (
      <svg viewBox="0 0 200 200" className="w-full h-full fill-none">
        {/* Floor Lines */}
        <MotionLine x1="20" y1="150" x2="180" y2="150" stroke="#4b5563" strokeWidth="2" />
          ...
          <div className="lg:w-1/2 flex flex-col justify-center space-y-2 relative z-10">
             {features.map((feature, idx) => (
               <MotionButton
                 ...
                 className={`text-left p-6 rounded-xl transition-all duration-300 border-l-4 group relative overflow-hidden ${
                    activeIdx === idx 
               ...
               >
                 <div className="flex justify-between items-center mb-1">
                   ...
                   {activeIdx === idx && (
                     <MotionDiv layoutId="active-dot" className="w-2 h-2 bg-fario-lime rounded-full" />
                   )}
                 </div>
