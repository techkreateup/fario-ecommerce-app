...
const GALLERY_DATA: Record<string, { label: string; img: string }[]> = {
    ...
    WOMEN: [
        ...
        { label: 'Luna Flex', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&q=80' },
        { label: 'Pearl Stride', img: 'https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=800&q=80' },
        { label: 'Bloom Lite', img: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=800&q=80' },
        { label: 'Velvet Force', img: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=800&q=80' },
        { label: 'Spark Trail', img: 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=800&q=80' },
        { label: 'Serenity Knit', img: 'https://images.unsplash.com/photo-1551107696-a4b0c5a0d9a2?w=800&q=80' },
    ],
    KIDS: [
