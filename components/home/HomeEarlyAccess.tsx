...
export const HomeEarlyAccess: React.FC = () => {
    ...
    return (
        <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-br from-[#3D364A] via-[#1A1625] to-[#0A0514]">
            {/* Background Narrative Layers - DRAMATIC GLOW */}
            ...
            <div className="container mx-auto px-4 md:px-12 lg:px-20 relative z-10">
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        >
                            <span className="inline-block px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-6 border border-white/10 bg-white/5 text-lime-400">
                                ✦ Limited Opportunity
                            </span>
