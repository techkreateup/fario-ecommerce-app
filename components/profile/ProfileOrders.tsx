                                            ...
                                            order.timeline.map((event: any, i: number) => (
                                                <div key={i} className="flex gap-4 relative">
                                                    <div className="flex flex-col items-center">
                                                        <div className={`w-8 h-8 ${i === order.timeline.length - 1 ? 'bg-fario-purple text-white animate-pulse' : 'bg-green-100 text-green-600'} rounded-full flex items-center justify-center z-10`}>
                                                    ...
                                                    <div>
                                                        <p className={`font-black ${i === order.timeline.length - 1 ? 'text-fario-purple text-lg' : 'text-gray-900'}`}>{event.status}</p>
