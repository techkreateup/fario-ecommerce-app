...
import {
    ...
    CheckCircle2, AlertCircle, CreditCard, Lock,
    RefreshCw, Download, Calendar, Activity, HelpCircle,
    ExternalLink, Mail
} from 'lucide-react';
                                ...
                                <>
                                    <Card title="Identity Information">
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            <Field label="Legal Business Name">
                                                <Input value={settings.legalName} onChange={(v) => update('legalName', v)} />
                                            </Field>
                                    ...
                                    <Card title="Tax Information">
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <Switch checked={settings.taxCalculation} onChange={(v) => update('taxCalculation', v)} />
                                        </div>
                                        <Field label="GST Registration Number">
                                            <Input placeholder="22AAAAA0000A1Z5" value={settings.taxId} onChange={(v) => update('taxId', v)} />
                                        </Field>
                                    </Card>
                                    ...
                                    <Card title="General Shipping Settings">
                                        <div className="grid grid-cols-2 gap-8">
                                            ...
                                            <Field label="Order Cutoff Time" helper="For same-day processing.">
                                                <Input type="time" value={settings.cutoffTime} onChange={(v) => update('cutoffTime', v)} />
                                            </Field>
                                        </div>
                                        <div className="mt-6">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <NotificationGroup title="Returns & Claims">
                                            <SwitchRow
                                                ...
                                                onChange={(v) => update('notifyReturns', v)}
                                            />
                                            <SwitchRow
                                                label="Claims & Chargebacks"
                                                checked={settings.notifyClaims}
                                                onChange={(v) => update('notifyClaims', v)}
                                            />
                                        </NotificationGroup>
                                        ...
                                        <NotificationGroup title="Account Health">
                                            <SwitchRow
                                                ...
                                                onChange={(v) => update('notifyHealth', v)}
                                                urgent
                                            />
                                        </NotificationGroup>
                                    </div>
                                ...
                                <>
                                    ...
                                    <Card title="Stock Logistics">
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <Switch checked={settings.ghostMode} onChange={(v) => update('ghostMode', v)} />
                                        </div>
                                        <Field label="Low Stock Warning Threshold">
                                            <Input
                                                type="number"
                                                value={settings.stockThreshold}
                                                onChange={(v) => update('stockThreshold', parseInt(v))}
                                                width="active"
                                            />
                                        </Field>
                                    </Card>
                                ...
                                <>
                                    ...
                                    <Card title="Credentials">
                                        <div className="flex items-center justify-between mb-6">
                                            ...
                                            <Switch checked={settings.twoFactor} onChange={(v) => update('twoFactor', v)} />
                                        </div>
                                    ...
                                    <Card title="Emergency Checkout Control">
                                        <div className={`p-6 rounded-lg border-2 ${settings.panicMode ? 'border-red-500 bg-red-50' : 'border-green-200 bg-white'}`}>
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <Switch checked={settings.panicMode} onChange={(v) => update('panicMode', v)} />
                                            </div>
